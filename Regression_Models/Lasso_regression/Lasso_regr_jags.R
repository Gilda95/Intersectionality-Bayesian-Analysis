...
setwd('/Users/gildamatteucci/OneDrive - Politecnico di Milano/PROGETTO_BAYESIANA/MCMCmodel')
...
setwd('/Users/gildamatteucci/OneDrive - Politecnico di Milano/PROGETTO_BAYESIANA/Github/BLASSO_regression')
...
save(outputRegress, time.taken, file='pdwrkSE_LASSO_output.Rdata')

setwd('/Users/gildamatteucci/OneDrive - Politecnico di Milano/PROGETTO_BAYESIANA/Github/BLASSO_regression')
load('pdwrkSE_LASSO_output.Rdata')
